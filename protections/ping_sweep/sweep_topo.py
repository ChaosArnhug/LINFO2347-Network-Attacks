...
def run():
    ...
    # Apply rules
    apply_nftables_rules(net, ['r1'], 'sweep_r1.nft')
    apply_nftables_rules(net, ['r2'], 'sweep_r2.nft')
    apply_nftables_rules(net, ['http'], 'sweep_http.nft')
    apply_nftables_rules(net, ['dns'], 'sweep_dns.nft')
    apply_nftables_rules(net, ['ftp'], 'sweep_ftp.nft')
    apply_nftables_rules(net, ['ntp'], 'sweep_ntp.nft')
