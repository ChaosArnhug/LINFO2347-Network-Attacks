...
def run():
    ...
    # Apply rules
    apply_nftables_rules(net, ['r1'], 'xmas_r1.nft')
    apply_nftables_rules(net, ['r2'], 'xmas_r2.nft')
    apply_nftables_rules(net, ['http'], 'xmas_http.nft')
    apply_nftables_rules(net, ['dns'], 'xmas_dns.nft')
    apply_nftables_rules(net, ['ftp'], 'xmas_ftp.nft')
    apply_nftables_rules(net, ['ntp'], 'xmas_ntp.nft')
    apply_nftables_rules(net, ['ws2'], 'xmas_ws.nft')
    apply_nftables_rules(net, ['ws3'], 'xmas_ws.nft')
