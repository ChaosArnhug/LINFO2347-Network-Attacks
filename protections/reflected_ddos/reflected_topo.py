...
def run():
    ...
    # Apply rules
    apply_nftables_rules(net, ['r1'], 'reflected_r1.nft')
    apply_nftables_rules(net, ['r2'], 'reflected_r2.nft')
    apply_nftables_rules(net, ['http'], 'reflected_http.nft')
    apply_nftables_rules(net, ['dns'], 'reflected_dns.nft')
    apply_nftables_rules(net, ['ftp'], 'reflected_ftp.nft')
    apply_nftables_rules(net, ['ntp'], 'reflected_ntp.nft')
