...
def run():
    ...
    # Apply rules
    apply_nftables_rules(net, ['r1'], 'flood_r1.nft')
    apply_nftables_rules(net, ['r2'], 'flood_r2.nft')
    apply_nftables_rules(net, ['http'], 'flood_http.nft')
    apply_nftables_rules(net, ['dns'], 'flood_dns.nft')
    apply_nftables_rules(net, ['ftp'], 'flood_ftp.nft')
    apply_nftables_rules(net, ['ntp'], 'flood_ntp.nft')
    apply_nftables_rules(net, ['ws2'], 'flood_ws.nft')
    apply_nftables_rules(net, ['ws3'], 'flood_ws.nft')
